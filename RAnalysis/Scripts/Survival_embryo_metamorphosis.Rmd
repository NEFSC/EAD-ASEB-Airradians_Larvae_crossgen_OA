...
pdf("Output/1_Survival_Growth/survival/embryo_to_metamorphosis/Experiment2_F1larvae_Survival_MeanSE_embryomet.pdf", width=10, height=5)
print(Exp2_larvae_PlotMeanSE)
dev.off()

pdf("Output/1_Survival_Growth/survival/embryo_to_metamorphosis/Experiment2_F1_Survival_MeanSE_embryomet.pdf", width=10, height=5)
...
pdf("Output/1_Survival_Growth/survival/embryo_to_metamorphosis/Experiment4_F2larvae_Survival_MeanSE_embryomet.pdf", width=10, height=5)
print(Exp4_larvae_PlotMeanSE)
dev.off()

pdf("Output/1_Survival_Growth/survival/embryo_to_metamorphosis/Experiment4_F2_Survival_MeanSE_embryomet.pdf", width=10, height=5)
...
capture.output(summary(TwoWay.Pre), file="Output/1_Survival_Growth/survival/embryo_to_metamorphosis/Pre_Metamorphosis_TwoWayANOVA.doc")
capture.output(SRH.Post, file="Output/1_Survival_Growth/survival/embryo_to_metamorphosis/Post_Metamorphosis_SRH.doc")
...
# plot the surv data
pdf("Output/4_F3_Full_factorial/survival/embryo_to_metamorphosis/Expeirment6_Survival_KaplanMeier_LowParent.pdf", width=5, height = 4)
Exp6_larvaeKaplanMeier.low
dev.off()

pdf("Output/4_F3_Full_factorial/survival/embryo_to_metamorphosis/Expeirment6_Survival_KaplanMeier_ModParent.pdf", width=5, height = 4)
Exp6_larvaeKaplanMeier.mod
dev.off()

pdf("Output/4_F3_Full_factorial/survival/embryo_to_metamorphosis/Expeirment6_Survival_KaplanMeier_HighParent.pdf", width=5, height = 4)
