...
binary_df_F1_MEANS$Generation <- 1
...
binary_df_F2_MEANS$Generation <- 2
# view the output binary format for building the surv object!
...
binary_F1_F2_masterMEANS   <- rbind(binary_df_F1_d10, binary_df_F2_d10) %>% dplyr::filter(!(Generation ==1 & 
                                                                                       Larvae_pCO2 %in% 'High pCO2'))
binary_F1_F2_moderate <- binary_F1_F2_masterMEANS %>% dplyr::filter(Larvae_pCO2 %in% 'Moderate pCO2')
binary_F1_F2_low      <- binary_F1_F2_masterMEANS %>% dplyr::filter(Larvae_pCO2 %in% 'Low pCO2')
