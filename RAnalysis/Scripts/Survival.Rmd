...
binary_df_F1_d14 <- binary_df_F1_all %>% dplyr::filter(!Age == 18)

unique(binary_df_F2_all$Age)
binary_df_F2_d14 <- binary_df_F2_all %>% dplyr::filter(!Age == 21)

binary_F1_F2_master   <- rbind(binary_df_F1_d14, binary_df_F2_d14)
...
# build the surv object! 
# with tank included in the data frame (first for loop above)
surv_F1_F2_mod  <- Surv(time = as.numeric(binary_F1_F2_moderate$Age), 
                     event = as.numeric(binary_F1_F2_moderate$Count_dead), type = "right")
surv_F1_F2_low  <- Surv(time = as.numeric(binary_F1_F2_low$Age), 
                     event = as.numeric(binary_F1_F2_low$Count_dead), type = "right")
# plot the surv data
# moderate
ggsurvplot(survfit(surv_F1_F2_mod ~ Generation, binary_F1_F2_moderate), 
           risk.table = F, pval = F , conf.int = TRUE,
...
# low
ggsurvplot(survfit(surv_F1_F2_low ~ Generation, binary_F1_F2_low), 
           risk.table = F, pval = F , conf.int = TRUE,
