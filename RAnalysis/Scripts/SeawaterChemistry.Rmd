...
FINAL_TABLE$pH             <- paste( (paste( (signif(carbchem.MASTER_wideMEANS$pH__Calculated, digits=3)),
...
FINAL_TABLE$TA             <- paste( (paste( (signif(carbchem.MASTER_wideMEANS$Total_alkalinity_mmol.kgSW, digits=3)),
...
FINAL_TABLE$DIC             <- paste( (paste( (signif(carbchem.MASTER_wideMEANS$Total_Dissolved_inorganic_carbon_mmol.kgSW, digits=3)),
