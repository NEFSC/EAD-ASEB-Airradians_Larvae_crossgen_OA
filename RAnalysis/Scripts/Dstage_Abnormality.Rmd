...
# number of runs 
unique(df$Run) # 1,2,3,4,6 - what are these? - Run = the different larval experiments, Runs 1-2 = larvae experiments, Runs 3-5 = F2 larvae experiments, and Run 6 = F3 larval experimentss. Runs 2, 4, and 6 went on to be raised in the flow through system. 
