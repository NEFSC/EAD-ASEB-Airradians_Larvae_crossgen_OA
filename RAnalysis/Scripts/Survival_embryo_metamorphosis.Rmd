...
# plot the surv data
pdf("Output/1_Survival_Growth/Expeirment2_Survival_KaplanMeier_age_stocking.pdf", width=5, height = 4)
...
# plot the surv data
pdf("Output/1_Survival_Growth/Expeirment2_Survival_KaplanMeier_proptime_stocking.pdf", width=5, height = 4)
...
binary_Exp2_Exp4_all             <- rbind( (binary_Exp2_larvae),# %>% dplyr::select(!cluster)),
                                           (binary_Exp4_larvae %>% dplyr::select(!c(Tank_num, ID)))
                                           ) %>% 
