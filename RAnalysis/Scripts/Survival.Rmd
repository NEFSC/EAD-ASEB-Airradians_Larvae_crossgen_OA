...
for (i in 1:nrow(df_Exp6)) {
   count_alive <- round(df_Exp6[i,]$Count_alive/1000) # divide all counts by 1000, round to nearest
   count_dead  <- round(df_Exp6[i,]$Count_dead/1000)  # divide all counts by 1000, round to nearest
...
for (i in 1:nrow(df_Exp6_MEANS)) {
   count_alive <- round(df_Exp6_MEANS[i,]$mean_Count_alive/1000) # divide all counts by 1000, round to nearest
   count_dead  <- round(df_Exp6_MEANS[i,]$mean_Count_dead/1000)  # divide all counts by 1000, round to nearest
...
#                                 N Observed Expected (O-E)^2/E (O-E)^2/V
# pCO2_all=High x High         1822     1628     1664    0.7643    1.7163
# pCO2_all=High x Low          1785     1576     1596    0.2608    0.5745
# pCO2_all=High x Moderate     1814     1580     1629    1.4871    3.2912
# pCO2_all=Low x High          1682     1531     1502    0.5663    1.2500
# pCO2_all=Low x Low           1748     1581     1575    0.0227    0.0502
# pCO2_all=Low x Moderate      1741     1585     1548    0.8684    1.9022
# pCO2_all=Moderate x High     1757     1573     1537    0.8396    1.8268
# pCO2_all=Moderate x Low      1761     1555     1548    0.0328    0.0714
# pCO2_all=Moderate x Moderate 1784     1577     1587    0.0578    0.1267


Exp4_logrank_test.low <- survdiff(formula = Surv(Age, Count_dead) ~ Larvae_pCO2, data = binary_Exp6_larvaeMEANS_LOW)
#                              N Observed Expected (O-E)^2/E (O-E)^2/V
# Larvae_pCO2=Low pCO2      1748     1581     1599    0.2083    0.6224
# Larvae_pCO2=Moderate pCO2 1741     1585     1573    0.0992    0.2924
# Larvae_pCO2=High pCO2     1682     1531     1525    0.0218    0.0636

Exp4_logrank_test.mod <- survdiff(formula = Surv(Age, Count_dead) ~ Larvae_pCO2, data = binary_Exp6_larvaeMEANS_MOD)
#                              N Observed Expected (O-E)^2/E (O-E)^2/V
# Larvae_pCO2=Low pCO2      1761     1555     1559   0.00998    0.0292
# Larvae_pCO2=Moderate pCO2 1784     1577     1598   0.27537    0.8191
# Larvae_pCO2=High pCO2     1757     1573     1548   0.40116    1.1712

Exp4_logrank_test.high <- survdiff(formula = Surv(Age, Count_dead) ~ Larvae_pCO2, data = binary_Exp6_larvaeMEANS_HIGH)
#                              N Observed Expected (O-E)^2/E (O-E)^2/V
# Larvae_pCO2=Low pCO2      1785     1576     1562  1.28e-01  3.68e-01
# Larvae_pCO2=Moderate pCO2 1814     1580     1594  1.24e-01  3.61e-01
# Larvae_pCO2=High pCO2     1822     1628     1628  3.64e-06  1.08e-05
```
...
#                                   coef  exp(coef)   se(coef)      z      p
# pCO2_allLow x Moderate       0.0257594  1.0260940  0.0205198  1.255 0.2094
# pCO2_allLow x High           0.0181278  1.0182931  0.0206986  0.876 0.3811
# pCO2_allModerate x Low       0.0004326  1.0004327  0.0206165  0.021 0.9833
# pCO2_allModerate x Moderate -0.0076837  0.9923458  0.0205460 -0.374 0.7084
# pCO2_allModerate x High      0.0319290  1.0324442  0.0205599  1.553 0.1204
# pCO2_allHigh x Low          -0.0259471  0.9743866  0.0205505 -1.263 0.2067
# pCO2_allHigh x Moderate     -0.0521540  0.9491827  0.0205392 -2.539 0.0111
# pCO2_allHigh x High         -0.0252755  0.9750413  0.0203818 -1.240 0.2149
...
# Fixed coefficients
#                                      coef exp(coef)   se(coef)     z    p
# pCO2_allLow x Moderate       0.0259311131 1.0262702 0.02240308  1.16 0.25
# pCO2_allLow x High           0.0180964582 1.0182612 0.02256621  0.80 0.42
# pCO2_allModerate x Low       0.0007710605 1.0007714 0.02249248  0.03 0.97
# pCO2_allModerate x Moderate -0.0077663981 0.9922637 0.02242517 -0.35 0.73
# pCO2_allModerate x High      0.0320923126 1.0326128 0.02243924  1.43 0.15
# pCO2_allHigh x Low          -0.0259064689 0.9744262 0.02243051 -1.15 0.25
# pCO2_allHigh x Moderate     -0.0522310451 0.9491096 0.02241907 -2.33 0.02
# pCO2_allHigh x High         -0.0253441580 0.9749743 0.02227480 -1.14 0.26
# 
# Random effects
#  Group Variable  Std Dev      Variance    
#  Tank  Intercept 0.0110032076 0.0001210706
...
pdf("Output/4_F3_Full_factorial/survival/Experiment6_HazardRatio_mixed_all.pdf", width = 12, height = 6) # three figures
ggarrange(Exp6_hazardratio_plotMIXED,Exp6_hazardratio_plot, ncol=2)
dev.off()
...
Exp6_coxph_test         <- coxph(formula = Surv(Age, Count_dead) ~ # using coxpH and Tank as random factor using 'frailty'
                                 ...
                                 data = binary_Exp6_larvae)
#                               coef exp(coef)  se(coef)      z        p
# Parent_pCO2Moderate pCO2 -0.006454  0.993567  0.011909 -0.542    0.588
# Parent_pCO2High pCO2     -0.049192  0.951998  0.011861 -4.147 3.37e-05
# Parent_pCO2None                 NA        NA  0.000000     NA       NA
# Larvae_pCO2Moderate pCO2 -0.002866  0.997138  0.011877 -0.241    0.809
# Larvae_pCO2High pCO2      0.016820  1.016962  0.011883  1.415    0.157
...
# output yo stuff homie!
capture.output(Exp6_coxph_test,file="Output/4_F3_Full_factorial/survival/Experiment6_Survival_CoxReg_mixedmodel_maineffects.doc")

pdf("Output/4_F3_Full_factorial/survival/Experiment6_HazardRatio_mixed_maineffects.pdf", width = 12, height = 6) # three figures
ggarrange(Exp6_hazardratio_plotMIXED,Exp6_hazardratio_plot, ncol=2)
dev.off()
...
#                             coef exp(coef) se(coef)     z     p
# Larvae_pCO2Moderate pCO2 0.02543   1.02575  0.02052 1.239 0.215
# Larvae_pCO2High pCO2     0.01799   1.01815  0.02070 0.869 0.385
...
binary_Exp6_larvae_LOW %>%  # same as above, using finalfit to output, includes frailty
   ...
   # Larvae_pCO2      Low pCO2 5247 (33.8)                         -                         -
   #             Moderate pCO2 5224 (33.7) 1.03 (0.99-1.07, p=0.215) 1.03 (0.99-1.07, p=0.202)
   #                 High pCO2 5043 (32.5) 1.02 (0.98-1.06, p=0.385) 1.02 (0.98-1.06, p=0.369)

Exp6_coxph_test.lowmixed    <- coxme(Surv(Age, Count_dead) ~ Larvae_pCO2 + (1 | Tank), data = binary_Exp6_larvae_LOW)
#                                coef exp(coef)   se(coef)    z    p
# Larvae_pCO2Moderate pCO2 0.02544567  1.025772 0.02052040 1.24 0.21
# Larvae_pCO2High pCO2     0.01800304  1.018166 0.02069916 0.87 0.38

Exp6_hazardratio_plot.low   <- ggforest(Exp6_coxph_test.low, data = binary_Exp6_larvae_LOW)
Exp6_coxph_test_table.low   <- coxph(Surv(Age, Count_dead) ~ Larvae_pCO2+(1|Tank), 
                                 data = binary_Exp6_larvae_LOW) %>%  tbl_regression(exp = TRUE) 

Exp6_hazardratio_plot.lowMIXED <- binary_Exp6_larvae_LOW %>% 
                                hr_plot(dependent_os, explanatory)

Exp6_hazardratio_plot.low   <- ggforest(Exp6_coxph_test.low, data = binary_Exp6_larvae_LOW)

pdf("Output/4_F3_Full_factorial/survival/Experiment6_HazardRatio_mixed_LOW.pdf", width = 12, height = 6) # three figures
ggarrange(Exp6_hazardratio_plot.lowMIXED,Exp6_hazardratio_plot.low, ncol=2)
dev.off()
...
binary_Exp6_larvae_MOD$Larvae_pCO2 <- factor(binary_Exp6_larvae_MOD$Larvae_pCO2, levels =c('Moderate pCO2', 'Low pCO2', 'High pCO2'))
...
#                                  coef exp(coef)   se(coef)     z    p
# Larvae_pCO2Moderate pCO2 -0.008389655 0.9916454 0.02063619 -0.41 0.68
# Larvae_pCO2High pCO2      0.031692021 1.0321996 0.02065370  1.53 0.12

Exp6_hazardratio_plot.mod   <- ggforest(Exp6_coxph_test.low, data = binary_Exp6_larvae_MOD)
Exp6_coxph_test_table.mod   <- coxph(Surv(Age, Count_dead) ~ Larvae_pCO2+(1|Tank), 
                                 data = binary_Exp6_larvae_MOD) %>%  tbl_regression(exp = TRUE) 

Exp6_hazardratio_plot.modMIXED <- binary_Exp6_larvae_MOD %>% 
                                hr_plot(dependent_os, explanatory)

Exp6_hazardratio_plot.mod   <- ggforest(Exp6_coxph_test.mod, data = binary_Exp6_larvae_MOD)

pdf("Output/4_F3_Full_factorial/survival/Experiment6_HazardRatio_mixed_MOD.pdf", width = 12, height = 6) # three figures
ggarrange(Exp6_hazardratio_plot.modMIXED,Exp6_hazardratio_plot.mod, ncol=2)
dev.off()
...
binary_Exp6_larvae_HIGH$Larvae_pCO2 <- factor(binary_Exp6_larvae_HIGH$Larvae_pCO2, levels =c('High pCO2', 'Low pCO2', 'Moderate pCO2'))
...
#                                coef  exp(coef)   se(coef)      z     p
# Larvae_pCO2Low pCO2      -8.026e-05  9.999e-01  2.041e-02 -0.004 0.997
# Larvae_pCO2Moderate pCO2 -2.613e-02  9.742e-01  2.040e-02 -1.281 0.200

binary_Exp6_larvae_HIGH %>%  # same as above, using finalfit to output, includes frailty
    finalfit(dependent_os, explanatory, add_dependent_label = FALSE)
   #       label        levels         all          HR (univariable)        HR (multivariable)
   # Larvae_pCO2     High pCO2 5466 (33.6)                         -                         -
   #                  Low pCO2 5350 (32.9) 1.00 (0.96-1.04, p=0.997) 1.00 (0.96-1.04, p=0.992)
   #             Moderate pCO2 5439 (33.5) 0.97 (0.94-1.01, p=0.200) 0.97 (0.94-1.01, p=0.201)

Exp6_coxph_test.highmixed    <- coxme(Surv(Age, Count_dead) ~ Larvae_pCO2 + (1 | Tank), data = binary_Exp6_larvae_HIGH)
#                                   coef exp(coef)   se(coef)     z   p
# Larvae_pCO2Low pCO2      -8.058636e-05 0.9999194 0.02040624  0.00 1.0
# Larvae_pCO2Moderate pCO2 -2.612879e-02 0.9742096 0.02039600 -1.28 0.2

Exp6_hazardratio_plot.high   <- ggforest(Exp6_coxph_test.low, data = binary_Exp6_larvae_HIGH)
Exp6_coxph_test_table.high   <- coxph(Surv(Age, Count_dead) ~ Larvae_pCO2+(1|Tank), 
                                 data = binary_Exp6_larvae_HIGH) %>%  tbl_regression(exp = TRUE) 

Exp6_hazardratio_plot.highMIXED <- binary_Exp6_larvae_HIGH %>% 
                                hr_plot(dependent_os, explanatory)

Exp6_hazardratio_plot.high   <- ggforest(Exp6_coxph_test.high, data = binary_Exp6_larvae_HIGH)

pdf("Output/4_F3_Full_factorial/survival/Experiment6_HazardRatio_mixed_HIGH.pdf", width = 12, height = 6) # three figures
ggarrange(Exp6_hazardratio_plot.highMIXED,Exp6_hazardratio_plot.high, ncol=2)
dev.off()
