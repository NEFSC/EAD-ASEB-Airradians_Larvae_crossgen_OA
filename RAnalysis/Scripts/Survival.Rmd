...
knitr::opts_knit$set(root.dir = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_Larvae_crossgen_OA/RAnalysis") # Sam's work
```
...
* we samples without replacement for microscopy counts to estimate survivroship and occasionally for respiration 
...
```{r proportion and percent data account for destructive sampling}
?tidyr::pivot_wider
