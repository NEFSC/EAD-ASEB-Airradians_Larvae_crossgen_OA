...
write.csv(RR_master_Exp3, "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_Larvae_crossgen_OA/RAnalysis/Output/Respiration/RR_calc_Experiment_3.csv")
...
write.csv(RR_master_Exp5, "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_Larvae_crossgen_OA/RAnalysis/Output/Respiration/RR_calc_Experiment_5.csv")
...
summary(aov(Exp3_TwoWayANOVA_T2)) # marginal effect of pCO2 offsrping
...
Exp3_OneANOVA_T2_MOD <- lm(mean_RR~pCO2_offspring, 
                          data=(Exp3_mean_T2 %>% 
                                  dplyr::filter(pCO2_parents %in% '800 uatm')))
shapiro.test(resid(Exp3_OneANOVA_T2_MOD)) # no pass
