...
# OUTPUT THE PLOT
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_Larvae_crossgen_OA/RAnalysis/Output/Respiration/plots/Experiment_3_MeanSE.pdf"), width = 6, height = 4)
print(Exp3_MeanSE)
dev.off()


pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_Larvae_crossgen_OA/RAnalysis/Output/Respiration/plots/Experiment_3_barplots.pdf"), width = 6, height = 4)
print(Exp3_barplot)
dev.off()
```
...
Exp3_TwoWayANOVA_T1 <- lm(mean_RR~pCO2_parents*pCO2_offspring, 
                          data=(Exp3_mean_tank %>% 
                                  dplyr::filter(Date %in% '4/20/2022')))
shapiro.test(resid(Exp3_TwoWayANOVA_T1)) # 0.4181
leveneTest(Exp3_TwoWayANOVA_T1) # 0.3977
summary(aov(Exp3_TwoWayANOVA_T1))
#                             Df    Sum Sq   Mean Sq F value Pr(>F)
# pCO2_parents                 2 3.360e-10 1.682e-10   0.155  0.859
# pCO2_offspring               2 9.230e-10 4.614e-10   0.425  0.668
# pCO2_parents:pCO2_offspring  3 2.053e-09 6.844e-10   0.630  0.616
# Residuals                    8 8.686e-09 1.086e-09

Exp3_TwoWayANOVA_T2 <- lm(mean_RR~pCO2_parents*pCO2_offspring, 
                          data=(Exp3_mean_tank %>% 
                                  dplyr::filter(Date %in% '4/22/2022')))
shapiro.test(resid(Exp3_TwoWayANOVA_T2)) # 0.1103
leveneTest(Exp3_TwoWayANOVA_T2) # 0.8943
...
Exp3_OneANOVA_T1LOW <- lm(mean_RR~pCO2_offspring, 
                          data=(Exp3_mean_tank %>% 
                                  dplyr::filter(Date %in% '4/20/2022' & pCO2_parents %in% '500 uatm')))
shapiro.test(resid(Exp3_OneANOVA_T1LOW)) # 0.2216
leveneTest(Exp3_OneANOVA_T1LOW) # 0.8042
summary(aov(Exp3_OneANOVA_T1LOW))
#                Df    Sum Sq   Mean Sq F value Pr(>F)
# pCO2_offspring  2 6.270e-10 3.133e-10   0.284  0.767
# Residuals       4 4.415e-09 1.104e-09
```
...
# OUTPUT THE PLOT
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_Larvae_crossgen_OA/RAnalysis/Output/Respiration/plots/Experiment_6_MeanSE.pdf"), width = 6, height = 4)
print(Exp6_MeanSE)
dev.off()


pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_Larvae_crossgen_OA/RAnalysis/Output/Respiration/plots/Experiment_6_barplots.pdf"), width = 6, height = 4)
print(Exp6_barplot)
dev.off()
```
