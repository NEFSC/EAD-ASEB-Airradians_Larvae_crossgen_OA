...
Exp2_coxph_test         <- coxph(formula = Surv(Age, Count_dead) ~ Larvae_pCO2, data = binary_Exp2_larvae) 
Exp2_hazardratio_plot   <- ggforest(Exp2_coxph_test, data = binary_Exp2_larvae)
Exp2_coxph_test_table   <- coxph(Surv(Age, Count_dead) ~ Larvae_pCO2, data = binary_Exp2_larvae) %>%  
                             tbl_regression(exp = TRUE) 

# mixed Cox proportional hazards regression model
Exp2_coxme_test         <- coxme(formula = Surv(Age, Count_dead) ~ Larvae_pCO2 +
                                   (1 | Tank), data = binary_Exp2_larvae)
...
capture.output(Exp2_coxme_test,file="Output/1_Survival_Growth/Experiment2_Survival_CoxReg.doc")
capture.output(Exp2_coxme_test_table,file="Output/1_Survival_Growth/Experiment2_Survival_CoxReg_HR.doc")

pdf("Output/1_Survival_Growth/Experiment2_HazardRatio.pdf", width = 6, height = 6) # three figures
...
Exp4_coxme_test         <- coxme(formula = Surv(Age, Count_dead) ~ Larvae_pCO2 +
                                   (1 | Tank_num), data = binary_Exp4_larvae)
...
capture.output(Exp4_coxme_test_table,file="Output/1_Survival_Growth/Experiment4_Survival_CoxReg_HR.doc")
...
binary_Exp2_Exp4_all             <- rbind(binary_Exp2_larvae, 
...
# Cox proportional hazards regression model
Exp2_Exp4_coxph_test       <- coxph(formula = Surv(Prop_time_metamophosis, Count_dead) 
                                    ~ Gen_pCO2, data = binary_Exp2_Exp4_all)
Exp2_Exp4_hazardratio_plot <- ggforest(Exp2_Exp4_coxph_test, data = binary_Exp2_Exp4_all)
Exp2_Exp4_coxph_test_table <- coxph(Surv(Prop_time_metamophosis, Count_dead) ~ Gen_pCO2, data = binary_Exp2_Exp4_all) %>%  
                                      tbl_regression(exp = TRUE) 
...
capture.output(Exp2_Exp4_coxme_test,file="Output/1_Survival_Growth/Experiments2&4_Survival_CoxReg.doc")
